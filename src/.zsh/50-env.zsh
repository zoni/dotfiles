...
# See also podman-system-service(1) manpage and podman.socket systemd unit.
...
if type sccache > /dev/null; then
	...
	test -e /etc/sccache.env && source /etc/sccache.env
fi

# GNU dircolors doesn't know alacritty at the moment.
